...
const AIChat: React.FC = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { role: 'model', text: 'Connection established. Ask about HIATUS 2025 lineup or tickets.' }
  ]);
          ...
          >
            ...
            <div className="bg-gradient-to-r from-fuchsia-900/50 to-purple-900/50 p-4 flex justify-between items-center border-b border-white/10">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-heading font-bold text-white tracking-wider">HIATUS AI</h3>
              </div>
